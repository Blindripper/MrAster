...
| `ASTER_KLINE_SIZING_MODE` | `expanded` | Kline window sizing profile (`adaptive`, `compact`, `expanded`, `static`); use `expanded` to retain broader history when signals are sparse. |
...
| `ASTER_MIN_QUOTE_VOL_USDT` | `900000` | Minimum volume for tradable symbols. |
