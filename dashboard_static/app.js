...
const TRANSLATIONS = {
  ru: {
    ...
    'quick.presets.low.subtitle': 'Мало сделок · лимит 30% риска на сделку',
    'quick.presets.mid.title': 'Mid',
    'quick.presets.mid.subtitle': 'Сбалансированная торговля · 50% риск на сделку',
  ...
  de: {
    ...
    'quick.presets.low.title': 'Low',
    'quick.presets.low.subtitle': 'Wenige Trades · 30% Risiko je Trade',
    'quick.presets.mid.title': 'Mid',
    'quick.presets.mid.subtitle': 'Ausgewogener Handel · 50% Risiko je Trade',
    'quick.presets.high.title': 'High',
    'quick.presets.high.subtitle': 'Hohe Frequenz · Aggressiv · 100% Risiko je Trade',
    'quick.presets.att.title': 'ATT',
  ...
  ko: {
    ...
    'quick.applyError': '오류',
    'quick.presets.low.title': 'Low',
    'quick.presets.low.subtitle': '거래 적음 · 거래당 위험 30%',
    'quick.presets.mid.title': 'Mid',
    'quick.presets.mid.subtitle': '균형 잡힌 트레이딩 · 거래당 위험 50%',
    'quick.presets.high.title': 'High',
  ...
  fr: {
    ...
    'quick.presets.low.title': 'Low',
    'quick.presets.low.subtitle': 'Basse fréquence · Risque 30% par trade',
    'quick.presets.mid.title': 'Mid',
    'quick.presets.mid.subtitle': 'Trading équilibré · Risque 50% par trade',
    'quick.presets.high.title': 'High',
  ...
  es: {
    ...
    'quick.presets.low.title': 'Low',
    'quick.presets.low.subtitle': 'Baja frecuencia · Riesgo 30% por operación',
    'quick.presets.mid.title': 'Mid',
    'quick.presets.mid.subtitle': 'Trading equilibrado · Riesgo 50% por operación',
    'quick.presets.high.title': 'High',
    'quick.presets.high.subtitle': 'Alta frecuencia · Agresivo · Riesgo 100% por operación',
    'quick.presets.att.title': 'ATT',
  ...
  tr: {
    ...
    'quick.presets.low.title': 'Low',
    'quick.presets.low.subtitle': 'Düşük frekans · İşlem başı %30 risk',
    'quick.presets.mid.title': 'Mid',
    'quick.presets.mid.subtitle': 'Dengeli trading · İşlem başı %50 risk',
    'quick.presets.high.title': 'High',
    'quick.presets.high.subtitle': 'Yüksek frekans · Agresif · İşlem başı %100 risk',
    'quick.presets.att.title': 'ATT',
  ...
  zh: {
    ...
    'quick.applyError': '错误',
    'quick.presets.low.title': 'Low',
    'quick.presets.low.subtitle': '低频交易 · 单笔风险30%',
    'quick.presets.mid.title': 'Mid',
    'quick.presets.mid.subtitle': '均衡交易 · 单笔风险50%',
    'quick.presets.high.title': 'High',
    'quick.presets.high.subtitle': '高频 · 进取 · 单笔风险100%',
    'quick.presets.att.title': 'ATT',
...
const PRESETS = {
  low: {
    label: 'Low',
    summary:
      'Capital preservation first: slower signal intake, narrower exposure, conservative scaling, a 30% risk-per-trade ceiling, and a 33% equity utilisation guard.',
    risk: 30,
    leverage: 4,
    edgeMinR: 0.08,
    slAtr: 1.1,
  ...
  mid: {
    label: 'Mid',
    summary:
      'Balanced cadence with moderate risk, a 50% risk-per-trade budget, 10× base leverage, and a 66% equity utilisation ceiling geared toward steady account growth.',
    risk: 50,
    leverage: 10,
    edgeMinR: 0.06,
    slAtr: 1.3,
  ...
  high: {
    label: 'High',
    summary:
      'High-frequency execution with a 100% risk-per-trade allocation, leverage auto-set to the exchange maximum, an unlimited AI spend cap, and full (100%) equity deployment when signals align.',
