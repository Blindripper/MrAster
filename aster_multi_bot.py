...
NO_CROSS_ADX_PAD = float(os.getenv("ASTER_NO_CROSS_ADX_PAD", "14.0"))
NO_CROSS_MOMENTUM_GAP_MAX = float(os.getenv("ASTER_NO_CROSS_MOMENTUM_GAP_MAX", "0.0200"))
NO_CROSS_MOMENTUM_RSI_PAD = float(os.getenv("ASTER_NO_CROSS_MOMENTUM_RSI_PAD", "1.0"))
NO_CROSS_MOMENTUM_ADX_PAD = float(os.getenv("ASTER_NO_CROSS_MOMENTUM_ADX_PAD", "18.0"))
NO_CROSS_TREND_GAP_MAX = float(os.getenv("ASTER_NO_CROSS_TREND_GAP_MAX", "0.0225"))
NO_CROSS_TREND_ADX_BONUS = float(os.getenv("ASTER_NO_CROSS_TREND_ADX_BONUS", "1.5"))
NO_CROSS_TREND_RSI_PAD = float(os.getenv("ASTER_NO_CROSS_TREND_RSI_PAD", "1.5"))
NO_CROSS_SOFT_PENALTY = float(os.getenv("ASTER_NO_CROSS_SOFT_PENALTY", "0.12"))
