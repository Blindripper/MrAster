...
NO_CROSS_RSI_PAD = float(os.getenv("ASTER_NO_CROSS_RSI_PAD", "2.5"))
...
NO_CROSS_TREND_RSI_PAD = float(os.getenv("ASTER_NO_CROSS_TREND_RSI_PAD", "1.0"))
...
ALIGN_RSI_PAD = float(os.getenv("ASTER_ALIGN_RSI_PAD", "3.0"))
