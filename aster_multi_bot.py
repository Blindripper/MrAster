...
NO_CROSS_EMA_GAP_MAX = float(os.getenv("ASTER_NO_CROSS_EMA_GAP_MAX", "0.0220"))
NO_CROSS_RSI_PAD = float(os.getenv("ASTER_NO_CROSS_RSI_PAD", "6.0"))
NO_CROSS_ADX_PAD = float(os.getenv("ASTER_NO_CROSS_ADX_PAD", "10.0"))
NO_CROSS_MOMENTUM_GAP_MAX = float(os.getenv("ASTER_NO_CROSS_MOMENTUM_GAP_MAX", "0.0240"))
NO_CROSS_MOMENTUM_RSI_PAD = float(os.getenv("ASTER_NO_CROSS_MOMENTUM_RSI_PAD", "0.5"))
NO_CROSS_MOMENTUM_ADX_PAD = float(os.getenv("ASTER_NO_CROSS_MOMENTUM_ADX_PAD", "14.0"))
NO_CROSS_TREND_GAP_MAX = float(os.getenv("ASTER_NO_CROSS_TREND_GAP_MAX", "0.0260"))
NO_CROSS_TREND_ADX_BONUS = float(os.getenv("ASTER_NO_CROSS_TREND_ADX_BONUS", "0.5"))
NO_CROSS_TREND_RSI_PAD = float(os.getenv("ASTER_NO_CROSS_TREND_RSI_PAD", "0.75"))
NO_CROSS_SOFT_PENALTY = float(os.getenv("ASTER_NO_CROSS_SOFT_PENALTY", "0.08"))
...
RSI_BUY_MIN = float(os.getenv("ASTER_RSI_BUY_MIN", "32"))
...
ADX_MIN_THRESHOLD = float(os.getenv("ASTER_ADX_MIN", "18.0"))
