...
NO_CROSS_EMA_GAP_MAX = float(os.getenv("ASTER_NO_CROSS_EMA_GAP_MAX", "0.0045"))
NO_CROSS_RSI_PAD = float(os.getenv("ASTER_NO_CROSS_RSI_PAD", "2.0"))
NO_CROSS_ADX_PAD = float(os.getenv("ASTER_NO_CROSS_ADX_PAD", "8.0"))
NO_CROSS_MOMENTUM_GAP_MAX = float(os.getenv("ASTER_NO_CROSS_MOMENTUM_GAP_MAX", "0.0075"))
NO_CROSS_MOMENTUM_RSI_PAD = float(os.getenv("ASTER_NO_CROSS_MOMENTUM_RSI_PAD", "3.0"))
NO_CROSS_MOMENTUM_ADX_PAD = float(os.getenv("ASTER_NO_CROSS_MOMENTUM_ADX_PAD", "13.0"))
...
TREND_EXTENSION_BARS = max(4, int(os.getenv("ASTER_TREND_EXTENSION_BARS", "26")))
TREND_EXTENSION_BARS_HARD = max(
    TREND_EXTENSION_BARS + 1, int(os.getenv("ASTER_TREND_EXTENSION_BARS_HARD", "42"))
)
