...
EDGE_RELIEF_THRESHOLD = float(os.getenv("ASTER_SKIP_EDGE_THRESHOLD", "0.30"))
...
EDGE_RELIEF_MIN_ABS = float(os.getenv("ASTER_SKIP_EDGE_MIN_ABS", "0.0115"))
...
NO_CROSS_EMA_GAP_MAX = float(os.getenv("ASTER_NO_CROSS_EMA_GAP_MAX", "0.0125"))
NO_CROSS_RSI_PAD = float(os.getenv("ASTER_NO_CROSS_RSI_PAD", "7.0"))
NO_CROSS_ADX_PAD = float(os.getenv("ASTER_NO_CROSS_ADX_PAD", "10.0"))
NO_CROSS_MOMENTUM_GAP_MAX = float(os.getenv("ASTER_NO_CROSS_MOMENTUM_GAP_MAX", "0.0135"))
NO_CROSS_MOMENTUM_RSI_PAD = float(os.getenv("ASTER_NO_CROSS_MOMENTUM_RSI_PAD", "2.0"))
NO_CROSS_MOMENTUM_ADX_PAD = float(os.getenv("ASTER_NO_CROSS_MOMENTUM_ADX_PAD", "15.0"))
NO_CROSS_TREND_GAP_MAX = float(os.getenv("ASTER_NO_CROSS_TREND_GAP_MAX", "0.0175"))
NO_CROSS_TREND_ADX_BONUS = float(os.getenv("ASTER_NO_CROSS_TREND_ADX_BONUS", "3.0"))
NO_CROSS_TREND_RSI_PAD = float(os.getenv("ASTER_NO_CROSS_TREND_RSI_PAD", "3.0"))
NO_CROSS_SOFT_PENALTY = float(os.getenv("ASTER_NO_CROSS_SOFT_PENALTY", "0.20"))
...
LONG_OVEREXTENDED_RSI = float(os.getenv("ASTER_LONG_OVEREXTENDED_RSI", "70.0"))
LONG_ATR_PCT_CAP = max(0.0, float(os.getenv("ASTER_LONG_ATR_PCT_CAP", "0.0135") or 0.0))
...
RSI_BUY_MIN = float(os.getenv("ASTER_RSI_BUY_MIN", "35"))
RSI_SELL_MAX = float(os.getenv("ASTER_RSI_SELL_MAX", "65"))
...
ADX_MIN_THRESHOLD = float(os.getenv("ASTER_ADX_MIN", "21.0"))
...
CONTINUATION_PULLBACK_STOCH_WARN = float(
    os.getenv("ASTER_CONT_PULLBACK_STOCH_WARN", "70.0") or 70.0
)
CONTINUATION_PULLBACK_STOCH_MAX = float(
    os.getenv("ASTER_CONT_PULLBACK_STOCH_MAX", "90.0") or 90.0
)
...
SHORT_TREND_SUPERTREND_TOL = float(
    os.getenv("ASTER_SHORT_TREND_SUPERTREND_TOL", "0.65") or 0.65
)
...
_PRESET_SIGNAL_TUNING: Dict[str, Dict[str, Any]] = {
    preset: dict(_BASE_SIGNAL_TUNING) for preset in ("low", "mid", "high", "att")
}
